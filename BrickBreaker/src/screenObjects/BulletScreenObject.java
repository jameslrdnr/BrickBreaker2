 ...
 * @author ge29779
 */
public class BulletScreenObject extends AbstractScreenObject{
    ...
    public BulletScreenObject() {
        super();

        init();
    }

    public BulletScreenObject(float xTemp, float yTemp, int widthTemp, int heightTemp, boolean collisionTemp, boolean acceptingInput, float playerDegrees, Color playerColor) {
    ...
    public BulletScreenObject(float xTemp, float yTemp, int widthTemp, int heightTemp, boolean collisionTemp, boolean acceptingInput, float playerDegrees, Color playerColor, int parentSpeedX, int parentSpeedY) {
        super(xTemp, yTemp, widthTemp, heightTemp, (short) 0, collisionTemp, acceptingInput);
        if (Debug.isEnabled()) {
            System.out.println("Creating Bullet at X : " + xTemp + " Y : " + yTemp);
        }
